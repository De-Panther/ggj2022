function createUnityInstance(canvas, config, onProgress) {
  ...
  async function fetchProgress(urlId, resolve)
  {
    let response = await fetch(Module[urlId], {'method': 'GET'});
    ...
    while(true) {
      ...
      onProgress(.5 * (receivedLength / contentLength));
    }
